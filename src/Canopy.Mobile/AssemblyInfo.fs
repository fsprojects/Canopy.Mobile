...
[<assembly: AssemblyVersionAttribute("1.6.7")>]
[<assembly: AssemblyFileVersionAttribute("1.6.7")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.6.7"
    let [<Literal>] AssemblyFileVersion = "1.6.7"
