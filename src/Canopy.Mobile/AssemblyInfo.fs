...
[<assembly: AssemblyVersionAttribute("1.6.6")>]
[<assembly: AssemblyFileVersionAttribute("1.6.6")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.6.6"
    let [<Literal>] AssemblyFileVersion = "1.6.6"
