...
[<assembly: AssemblyVersionAttribute("1.3.1.5")>]
[<assembly: AssemblyFileVersionAttribute("1.3.1.5")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.1.5"
    let [<Literal>] AssemblyFileVersion = "1.3.1.5"
