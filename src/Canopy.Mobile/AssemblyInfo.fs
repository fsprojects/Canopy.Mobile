...
[<assembly: AssemblyVersionAttribute("1.3.1.4")>]
[<assembly: AssemblyFileVersionAttribute("1.3.1.4")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.1.4"
    let [<Literal>] AssemblyFileVersion = "1.3.1.4"
