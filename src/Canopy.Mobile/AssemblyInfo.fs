...
[<assembly: AssemblyVersionAttribute("1.6.8")>]
[<assembly: AssemblyFileVersionAttribute("1.6.8")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.6.8"
    let [<Literal>] AssemblyFileVersion = "1.6.8"
