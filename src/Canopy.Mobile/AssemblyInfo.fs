...
[<assembly: AssemblyVersionAttribute("1.3.1.2")>]
[<assembly: AssemblyFileVersionAttribute("1.3.1.2")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.3.1.2"
    let [<Literal>] AssemblyFileVersion = "1.3.1.2"
